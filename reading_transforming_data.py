...
#saving my files
customer_df.to_csv(r'datasets\cleaned_data\customer.csv', index = False)
product_df.to_csv(r'datasets\cleaned_data\product.csv', index = False)
shipping_address_df.to_csv(r'datasets\cleaned_data\shipping.csv', index = False)
orders_df.to_csv(r'datasets\cleaned_data\orders.csv', index = False)
payment_method_df.to_csv(r'datasets\cleaned_data\payment_method.csv', index = False)
